...
public class HW2_Task123 {
    ...
    public static void task3_places_train_else() {
        ...
        int seatPass = 60;
        int standPass = 41;
        if (seatPass < seatsTrain && standPass < standTrain) {
            System.out.println("В вагоне доступно:\n" + "сидячих мест - " + (seatsTrain - seatPass) + ";\n" +
                    "стоячих мест - " + (standTrain - standPass) + ".\n");
        } else if (seatPass >= seatsTrain && standPass < standTrain) {
            System.out.println("В вагоне доступно стоячих мест - " + (standTrain - standPass) + ".\n");
        } else if (seatPass < seatsTrain && standPass >= standTrain) {
            System.out.println("В вагоне доступно сидячих мест - " + (seatsTrain - seatPass) + ".\n");
        } else {
            System.out.println("Вагон полностью занят - мест нет!\n");
        }
    }
}
