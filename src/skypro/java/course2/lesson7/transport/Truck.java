package skypro.java.course2.lesson7.transport;

public class Truck extends Transport implements Competing {
    private final String TYPE = "Грузовой автомобиль.";
    private final LoadCapacity loadCapacity;

    public Truck(String brand, String model, float engineVolume, boolean diagnosticsPassed, LoadCapacity loadCapacity) {
